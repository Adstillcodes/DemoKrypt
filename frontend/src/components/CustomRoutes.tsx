...
import Random12DigitGenerator from "../pages/Admin/Random12DigitGenerator";
  ...
  const getRoutes = (): JSX.Element => {
    ...
    if (authContext.authenticated) {
      ...
      const adminMenu = [
        ...
        {name: "Citizenship Number Generator", link: "/Random12DigitGenerator" },
      ];
        ...
        return (
          <Default menu={adminMenu}>
            <Routes>
              ...
              <Route path="/Random12DigitGenerator" element={<Random12DigitGenerator/>} />
            </Routes>
          </Default>
        );
      } else {
